function player_animation_list(){
	switch(global.character)
	{
		...
		animation_add(ANIM_CORKSCREW_L, spr_sonic_twirl_left, 0, 0, true, true);
		animation_add(ANIM_CORKSCREW_R, spr_sonic_twirl_right, 0, 0, true, true);
		break;
		...
		animation_add(ANIM_LEDGE2, spr_knuckles_ledge1, [8,8,8,8,8,8,48,8], 9, true, true);
