/// @description Set the value
	...
	//Dev stuff
	global.dev_mode = false;					//Flag for developer mode, which allows you to use dev commands, don't forget to turn this off when releasing the game
	
	//Character globals
	global.character = CHAR_SONIC;			//Global value for the character
	
	//Screen values
	global.window_width  = 424;				//Window's horizontal size
	...
	//Setup volume
	global.bgm_volume = 0.8;//dev time!			//Music's channel volume
	global.sfx_volume = 0.8;					//Sound effects volume
	...
	instance_create_depth(0, 0, 0, obj_shader);
